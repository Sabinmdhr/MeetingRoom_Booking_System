    ...
    >
      ...
      {eventDataLoading ? (
        ...
        <div className="calendar-modal__body">
          <Row icon={<Clock color="blue" size={18} />}>
          ...
          <Row icon={<Users color="green" size={18} />}>
            <Accordion>
              <AccordionSummary
          ...
          <Row icon={<Menu color="red" size={18} />}>
            <Typography
              className="calendar-modal__row__label"
              variant="subtitle1"
            >
          ...
          <Row icon={<MapPin color="purple" size={18} />}>
            <Typography
              className="calendar-modal__row__label"
              variant="subtitle1"
            >
          ...
          <Row icon={<CircleUser color="blue" size={18} />}>
            <Typography
              className="calendar-modal__row__label"
              variant="subtitle1"
            >
